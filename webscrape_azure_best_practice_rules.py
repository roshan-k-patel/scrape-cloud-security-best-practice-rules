...
def main():
    ...
    filename = "azure_best_practice_rules.csv"
    headers = "Title, Azure Service, Risk, ID, Description, Rationale, Audit Goal, Audit Console, Audit Cli, Remediation Console, Remediation Cli, Link\n"
